...
def sort_population(pop):
	...
	return pop
def input_data():
	def same_file(lowerbound, upperbound, filename):
		'''
		PURPOSE: 
	...
	fieldNames = ["Generations", "Population Size", "Chance of Mutation (between 0 and 1)", "upperbound", "lowerbound", "Filepath to Input Data"]
	...
	X_data, target1, target2 = same_file(int(fieldValues[4]), int(fieldValues[3]), fieldValues[5])
